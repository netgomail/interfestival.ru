...
<div class="fest">
  ...
  <? endif;?>
	...
	<? if($arResult["PROPERTIES"]["NAME_EN"]["VALUE"]):?>
			...
			<div class="title_en" style="margin-bottom:35px;"> <?=$arResult["PROPERTIES"]["NAME_EN"]["VALUE"];?> </div>
	<? else:?>
			<h1><?=$arResult["NAME"]?></h1>
	<? endif;?>
  ...
  <div class="place">
    ...
    <div class="coutry">
      <table style="vertical-align:middle;">
        <tbody>
          <tr>
            <td><a href="/festivaly/?festFilter_pf[PLACE]=<?=$arElem["ID"]?>&set_filter=Y"/><img src="<?=$file['src'];?>" width="<?=$file['width'];?>" height="<?=$file['height'];?>" alt="<?=$arElem['NAME']?>"  /></a></td>
