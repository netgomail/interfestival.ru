...
foreach ($arResult['SECTIONS'] as $key => $arSection)
{
$id = $arSection['UF_FLAG'];
$arSelect = Array("ID", "NAME", "DATE_ACTIVE_FROM", "PREVIEW_PICTURE");
$arFilter = Array("IBLOCK_ID"=>IntVal(6), "ID"=>IntVal($id), "ACTIVE_DATE"=>"Y", "ACTIVE"=>"Y");
...
while($ob = $res->GetNextElement())
{
 ...
 //print_r($arFields);
 $arResult['SECTIONS'][$key]['FLAG_PIC'] = CFile::GetPath($arFields['PREVIEW_PICTURE']); 
}
} 
