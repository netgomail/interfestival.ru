 ...
 *************************************************************************/
echo "<!-- component.php: ";var_dump($_REQUEST);echo " -->";
...
foreach($arParams["FIELD_CODE"] as $field_code)
{
    ...
    switch ($field_code)
    {
        ...
        case "START_DATE":
            ...
            echo "<!-- field_code && value_right && value_left && name:: ";var_dump($field_code, $value_right, $value_left, $name); " -->";
            ${$FILTER_NAME}[">=".$field_code] = "";
            ${$FILTER_NAME}["<".$field_code] = "";
            break;
...
foreach($arResult["arrProp"] as $prop_id => $arProp)
{
    ...
    echo "<!-- property_type:: "; var_dump($arProp["PROPERTY_TYPE"]); echo " -->";
